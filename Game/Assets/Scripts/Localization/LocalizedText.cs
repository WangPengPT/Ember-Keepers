...
{
    /// <summary>
    /// 本地化文本组件 - 自动根据当前语言更新文本
    /// 支持 TextMeshProUGUI 和 Text 组件
    /// </summary>
    ...
    public class LocalizedText : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            {
                Debug.LogWarning($"LocalizedText: GameObject '{gameObject.name}' 上没有找到 TextMeshProUGUI 或 Text 组件");
            }
        ...
        public void UpdateText()
        {
            ...
            {
                Debug.LogWarning($"LocalizedText: GameObject '{gameObject.name}' 的本地化键为空");
                return;
            }

            if (LocalizationManager.Instance == null)
            {
                Debug.LogWarning($"LocalizedText: LocalizationManager 实例不存在");
                return;
            }
